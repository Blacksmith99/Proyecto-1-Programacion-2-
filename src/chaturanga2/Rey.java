...
public class Rey extends Ficha {
    ...
    public static boolean MovimientoenLdelRojo=true;
    public static boolean MovimientoenLdelVerde=true;
    ...
    @Override
       public void Mover(int f1,int col1, int f2, int col2){
            ...
            if(((f2 <8) && (col2 <8)) && (Tablero.Tablero [f2][col2].equals("--") || Tablero.Tablero[f2][col2].charAt(1) != 'R' ) && (((f2== f1 +1 || f2 == f1 -1) && col2 == col1) || ((col2 ==col1 +1) || col2== col1 -1 && f2 == f1) || ((f2== f1 -1) && (col2 == col1 -1)) || ((f2 == f1 -1)&& (col2 == col1 +1)) || ((f2 == f1 +1) && (col2 == col1 -1)) || ((f2== f1 +1) && (col2 == col1 +1)))  || (MovimientoenLdelRojo && ((f2 < 8) && (col2 < 8)) && (Tablero.Tablero [f2][col2].equals("--") || Tablero.Tablero[f2][col2].charAt(1) != 'R' ) && ( (((f2 == f1 -1) && (col2 == col1 -2)) || ((f2 == f1 +1) && (col2 == col1 -2))) || (((f2 == f1 -2) && (col2== col1 -1)) || ((f2 == f1 -2) && (col2 == col1 +1))) || ((( f2 == f1 -1) && (col2 == col1 +2)) || (( f2 == f1 +1) && (col2 == col1 +2))) || ((( f2 == f1 +2) && (col2 == col1 -1)) || ((f2 == f1 +2) && (col2 == col1 +1)))))){
               
            
             if(Tablero.Tablero[f2][col2].charAt(1) != 'R' && (Tablero.Tablero[f2][col2].charAt(0) == 'P' || Tablero.Tablero[f2][col2].charAt(0) == 'T' || Tablero.Tablero[f2][col2].charAt(0) == 'C' || Tablero.Tablero[f2][col2].charAt(0) == 'E' || Tablero.Tablero[f2][col2].charAt(0) == 'V' || Tablero.Tablero[f2][col2].charAt(0) == 'R')){
             ...
             if(Tablero.Tablero[f2][col2].charAt(0)== 'P'){
                          ...
                          System.out.println("El Rey de "+ Menu.j1 +" se ha comido al Elefante de "+Menu.j2+" ");
                      }else if(Tablero.Tablero [f2][col2].charAt(0) == 'V'){
                          System.out.println("El Rey de "+ Menu.j1 +" se ha comido al Visir de "+Menu.j2+" ");
             ...
             Tablero.ImprimirTablero();
                ...
                if(((f2 <8) && (col2 <8)) && (Tablero.Tablero [f2][col2].equals("--") || Tablero.Tablero[f2][col2].charAt(1) != 'V' ) && (((f2== f1 +1 || f2 == f1 -1) && col2 == col1) || ((col2 ==col1 +1) || col2== col1 -1 && f2 == f1) || ((f2== f1 -1) && (col2 == col1 -1)) || ((f2 == f1 -1)&& (col2 == col1 +1)) || ((f2 == f1 +1) && (col2 == col1 -1)) || ((f2== f1 +1) && (col2 == col1 +1))) ||  (MovimientoenLdelVerde && ((f2 < 8) && (col2 < 8)) && (Tablero.Tablero [f2][col2].equals("--") || Tablero.Tablero[f2][col2].charAt(1) != 'R' ) && ( (((f2 == f1 -1) && (col2 == col1 -2)) || ((f2 == f1 +1) && (col2 == col1 -2))) || (((f2 == f1 -2) && (col2== col1 -1)) || ((f2 == f1 -2) && (col2 == col1 +1))) || ((( f2 == f1 -1) && (col2 == col1 +2)) || (( f2 == f1 +1) && (col2 == col1 +2))) || ((( f2 == f1 +2) && (col2 == col1 -1)) || ((f2 == f1 +2) && (col2 == col1 +1)))))){
               
            
             if(Tablero.Tablero[f2][col2].charAt(1) != 'V' && (Tablero.Tablero[f2][col2].charAt(0) == 'P' || Tablero.Tablero[f2][col2].charAt(0) == 'T' || Tablero.Tablero[f2][col2].charAt(0) == 'C' || Tablero.Tablero[f2][col2].charAt(0) == 'E' || Tablero.Tablero[f2][col2].charAt(0) == 'V' || Tablero.Tablero[f2][col2].charAt(0) == 'R')){
             ...
             if(Tablero.Tablero[f2][col2].charAt(0)== 'P'){
                          ...
                          System.out.println("El Rey de "+Menu.j2+" se ha comido al Elefante de "+ Menu.j1 +" ");
                      }else if(Tablero.Tablero [f2][col2].charAt(0) == 'V'){
                          System.out.println("El Rey de "+Menu.j2+" se ha comido al Visir de "+ Menu.j1 +" ");
                      }else if(Tablero.Tablero [f2][col2].charAt(0) == 'R'){
