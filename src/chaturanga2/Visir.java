 ...
 * @author Josue
 */
public class Visir extends Ficha {
    
    
    public Visir(int a, int b){
    ...
    public void Mover(int fi,int ci, int ff, int cf){
        ...
        if(Tablero.turno){
            ...
            if(((ff <8) && (cf <8)) && (Tablero.Tablero[ff][cf].equals("--") || Tablero.Tablero[ff][cf].charAt(1) != 'R') && (((ff == fi -1) && (cf == ci -1)) || ((ff == fi-1) && (cf == ci +1)) || ((ff == fi +1) && (cf == ci -1)) || ((( ff == fi +1) && (cf == ci +1)) ))){
        
               if(Tablero.Tablero[ff][cf].charAt(1) != 'R' && (Tablero.Tablero[ff][cf].charAt(0) == 'P' || Tablero.Tablero[ff][cf].charAt(0) == 'T' || Tablero.Tablero[ff][cf].charAt(0) == 'C' || Tablero.Tablero[ff][cf].charAt(0) == 'E' || Tablero.Tablero[ff][cf].charAt(0) == 'V' || Tablero.Tablero[ff][cf].charAt(0) == 'R')){
             
             
                   if(Tablero.Tablero[ff][cf].charAt(0)== 'P'){
                          System.out.println("El Visir de "+Menu.j1+" se ha comido al Peon de "+Menu.j2+" ");
                      }else if(Tablero.Tablero[ff][cf].charAt(0)=='T'){
                          System.out.println("El Visir de "+Menu.j1+" se ha comido a la Torre de "+Menu.j2+"");
                      }else if(Tablero.Tablero[ff][cf].charAt(0) == 'C'){
                          System.out.println("El Visir de "+Menu.j1+" se ha comido al Caballo de "+Menu.j2+"");
                      }else if(Tablero.Tablero[ff][cf].charAt(0) == 'E'){
                          System.out.println("El Visir de "+Menu.j1+" se ha comido al Elefante de "+Menu.j2+"");
                      }else if(Tablero.Tablero [ff][cf].charAt(0) == 'V'){
                          System.out.println("El Visir de "+Menu.j1+" se ha comido al Visir de "+Menu.j2+"");
                      }else if(Tablero.Tablero [ff][cf].charAt(0) == 'R'){
        ...
        if(((ff <8) && (cf <8)) && (Tablero.Tablero[ff][cf].equals("--") || Tablero.Tablero[ff][cf].charAt(1) != 'V') && (((ff == fi -1) && (cf == ci -1)) || ((ff == fi-1) && (cf == ci +1)) || ((ff == fi +1) && (cf == ci -1)) || ((( ff == fi +1) && (cf == ci +1)) ))){
            
            if(Tablero.Tablero[ff][cf].charAt(1) != 'V' && (Tablero.Tablero[ff][cf].charAt(0) == 'P' || Tablero.Tablero[ff][cf].charAt(0) == 'T' || Tablero.Tablero[ff][cf].charAt(0) == 'C' || Tablero.Tablero[ff][cf].charAt(0) == 'E' || Tablero.Tablero[ff][cf].charAt(0) == 'V' || Tablero.Tablero[ff][cf].charAt(0) == 'R')){
             
             
             if(Tablero.Tablero[ff][cf].charAt(0)== 'P'){
                          System.out.println("El Visir de "+Menu.j2+" se ha comido al Peon de "+Menu.j1+"");
                      }else if(Tablero.Tablero[ff][cf].charAt(0)=='T'){
                          System.out.println("El Visir de "+Menu.j2+" se ha comido a la Torre de "+Menu.j1+"");
                      }else if(Tablero.Tablero[ff][cf].charAt(0) == 'C'){
                          System.out.println("El Visir de "+Menu.j2+"  se ha comido al Caballo de "+Menu.j1+"");
                      }else if(Tablero.Tablero[ff][cf].charAt(0) == 'E'){
                          System.out.println("El Visir de "+Menu.j2+" se ha comido al Elefante de "+Menu.j1+"");
                      }else if(Tablero.Tablero [ff][cf].charAt(0) == 'V'){
                          System.out.println("El Visir de "+Menu.j2+" se ha comido al Visir de "+Menu.j1+"");
                      }else if(Tablero.Tablero [ff][cf].charAt(0) == 'R'){
