    ...
    @Override
     public void Mover(int fila1, int columna1, int fila2, int columna2){
         ...
         if(Tablero.turno){
           ...
           if(((fila2 < 8) && (columna2 < 8)) && (Tablero.Tablero [fila2][columna2].equals("--") || Tablero.Tablero[fila2][columna2].charAt(1) != 'R' ) && ( (((fila2 == fila1 -1) && (columna2 == columna1 -2)) || ((fila2 == fila1 +1) && (columna2 == columna1 -2))) || (((fila2 == fila1 -2) && (columna2== columna1 -1)) || ((fila2 == fila1 -2) && (columna2 == columna1 +1))) || ((( fila2 == fila1 -1) && (columna2 == columna1 +2)) || (( fila2 == fila1 +1) && (columna2 == columna1 +2))) || ((( fila2 == fila1 +2) && (columna2 == columna1 -1)) || ((fila2 == fila1 +2) && (columna2 == columna1 +1))))){
             ...
             if(Tablero.Tablero[fila2][columna2].charAt(0)== 'P'){
                          System.out.println("El Caballo de "+Menu.j1+" se ha comido al Peon de "+Menu.j2+" ");
                      }else if(Tablero.Tablero[fila2][columna2].charAt(0)=='T'){
                          System.out.println("El Caballo de "+Menu.j1+" se ha comido a la Torre de "+Menu.j2+" ");
                      }else if(Tablero.Tablero[fila2][columna2].charAt(0) == 'C'){
                          System.out.println("El Caballo de "+Menu.j1+" se ha comido al Caballo de "+Menu.j2+" ");
                      }else if(Tablero.Tablero[fila2][columna2].charAt(0) == 'E'){
                          System.out.println("El Caballo de "+Menu.j1+" se ha comido al Elefante de "+Menu.j2+" ");
                      }else if(Tablero.Tablero [fila2][columna2].charAt(0) == 'V'){
                          System.out.println("El Caballo de "+Menu.j1+" se ha comido al Visir de "+Menu.j2+" ");
         ...
         if(((fila2 < 8) && (columna2 < 8)) && (Tablero.Tablero [fila2][columna2].equals("--") || Tablero.Tablero[fila2][columna2].charAt(1) != 'V' ) && ( (((fila2 == fila1 -1) && (columna2 == columna1 -2)) || ((fila2 == fila1 +1) && (columna2 == columna1 -2))) || (((fila2 == fila1 -2) && (columna2== columna1 -1)) || ((fila2 == fila1 -2) && (columna2 == columna1 +1))) || ((( fila2 == fila1 -1) && (columna2 == columna1 +2)) || (( fila2 == fila1 +1) && (columna2 == columna1 +2))) || ((( fila2 == fila1 +2) && (columna2 == columna1 -1)) || ((fila2 == fila1 +2) && (columna2 == columna1 +1))))){
              ...
              if(Tablero.Tablero[fila2][columna2].charAt(0)== 'P'){
                          System.out.println("El Caballo de "+Menu.j2+" se ha comido al Peon de "+Menu.j1+" ");
                      }else if(Tablero.Tablero[fila2][columna2].charAt(0)=='T'){
                          System.out.println("El Caballo de "+Menu.j2+" se ha comido a la Torre de "+Menu.j1+" ");
                      }else if(Tablero.Tablero[fila2][columna2].charAt(0) == 'C'){
                          System.out.println("El Caballo de "+Menu.j2+" se ha comido al Caballo de "+Menu.j1+" ");
                      }else if(Tablero.Tablero[fila2][columna2].charAt(0) == 'E'){
                          System.out.println("El Caballo de "+Menu.j2+" se ha comido al Elefante de "+Menu.j1+" ");
                      }else if(Tablero.Tablero [fila2][columna2].charAt(0) == 'V'){
                          System.out.println("El Caballo de "+Menu.j2+" se ha comido al Visir de "+Menu.j1+"");
                      }else if(Tablero.Tablero [fila2][columna2].charAt(0) == 'R'){
